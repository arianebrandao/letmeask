      ...
      <main>
        ...
        <form onSubmit={handleNewQuestion}>
          ...
          <div className="form-footer">
            { user ? (
              ...
              <span>Para enviar uma pergunta, <button type="button" onClick={handleSignIn}>faça o seu login</button>.</span>
            ) }
        ...
        <div className="question-list">
          {questions.map(question => {
            ...
            <div className="question-list">
              <div className="questions-answered">Perguntas respondidas</div>
